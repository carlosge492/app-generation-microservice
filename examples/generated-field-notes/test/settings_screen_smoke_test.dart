...
import 'package:field_notes/ui/settings_screen.dart';
import 'package:field_notes/models/observation.dart';
import 'package:field_notes/providers/observation_providers.dart';

void main() {
  testWidgets('SettingsScreen builds without throwing', (WidgetTester tester) async {
    ...
    if (error != null) {
      ...
      expect(
        ...
        reason: 'unexpected exception while building SettingsScreen',
      );
    }
