...
import 'package:field_notes/ui/capture_screen.dart';

void main() {
  testWidgets('CaptureScreen builds without throwing', (WidgetTester tester) async {
    ...
    if (error != null) {
      ...
      expect(
        ...
        reason: 'unexpected exception while building CaptureScreen',
      );
    }
