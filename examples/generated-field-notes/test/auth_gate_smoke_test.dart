...
import 'package:field_notes/ui/auth_gate.dart';

void main() {
  testWidgets('AuthGate builds without throwing', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      UncontrolledProviderScope(
        container: container,
        child: const MaterialApp(home: Scaffold(body: AuthGate())),
      ),
    );
    await tester.pump();
    ...
    if (error != null) {
      ...
      expect(
        ...
        reason: 'unexpected exception while building AuthGate',
      );
    }
